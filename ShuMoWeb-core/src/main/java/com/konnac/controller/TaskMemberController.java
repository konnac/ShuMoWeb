...
import com.konnac.BatchResult;
import com.konnac.PageBean;
import com.konnac.Result;
import com.konnac.TaskMember;
...
public class TaskMemberController {
    ...
    public Result page(@PathVariable Integer projectId,
        ...
        Boolean isAdmin = com.konnac.utils.AuthUtils.getCurrentUser().getRole() == com.konnac.User.UserRole.ADMIN;
